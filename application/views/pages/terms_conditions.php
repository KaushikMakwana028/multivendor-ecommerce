...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* brass bead-chain divider, echoing the home page */
        .bead-divider {
            display: flex;
            align-items: center;
        ...
        /* thin gold rule along the top edge, temple-manuscript feel */
        .content-card::before {
            content: "";
            position: absolute;
            top: 0;
        ...
        /* simple shimmer skeleton while loading */
        .skeleton-line {
            height: 14px;
            border-radius: 6px;
    ...
    <script>
        fetch("<?= htmlspecialchars($api_url, ENT_QUOTES, 'UTF-8') ?>")
            ...
            .then(function(result) {
                ...
                if (data.content) {
                    // API returns HTML markup (h2/p tags), so render it as markup, not plain text
